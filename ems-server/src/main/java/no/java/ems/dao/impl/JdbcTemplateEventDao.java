...
import static no.java.ems.server.f.ExternalV2F.intervalGetStart;
import static no.java.ems.server.f.ExternalV2F.intervalToPeriod;
import static no.java.ems.server.f.ExternalV2F.periodGetMinutes;
