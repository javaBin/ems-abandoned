...
public class Person extends AbstractEntity implements Comparable<Person> {
    ...
    public void setEmailAddresses(final Collection<EmailAddress> emailAddresses) {
        if (emailAddresses != null) {
            this.emailAddresses = new ArrayList<EmailAddress>(emailAddresses);
        }
    }
